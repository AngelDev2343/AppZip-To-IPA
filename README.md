...
Download the scripts from the [Releases](../../releases/latest) page or clone this repo.
...
- **macOS / Linux** — `bash`, `unzip`, `zip` (pre-installed on most systems)
...
Descarga los scripts desde la página de [Releases](../../releases/latest) o clona este repositorio.
...
- **macOS / Linux** — `bash`, `unzip`, `zip` (preinstalados en la mayoría de sistemas)
